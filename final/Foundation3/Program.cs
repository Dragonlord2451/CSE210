...
public class Program
{
    public static void Main()
    {
        ...
        Reception reception = new Reception("Networking Event", "A chance to network with industry professionals.", new DateTime(2024, 8, 2, 18, 0, 0), receptionAddress, "RSMVPJohndoe@gamil.com");
